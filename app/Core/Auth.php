 ...
 * необовʼязковий режим перегляду: людина може «вдати» роль, щоб перевірити,
...
class Auth
{
    ...
    // ── Режим перегляду (симуляція ролі) ────────────────────────────────────
     ...
     */
    /**
     * Магазини, доступні за СПРАВЖНІМИ правами. Режим перегляду тут не враховуємо
    ...
    private static function deny(?string $cap = null): void
    {
        ...
        if ($act !== null && $hasReally) {
            flash('error', 'У режимі перегляду «' . Roles::label($act) . '» це недоступно. '
