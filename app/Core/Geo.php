...
/**
 * Координати точок продажу та карта.
 *
...
class Geo
{
    /** Ключ Google Maps JS API. Порожній — карта не показується, лишаються посилання. */
    public static function key(): string
    {
        return trim((string)Settings::get('google_maps_key', ''));
    }
