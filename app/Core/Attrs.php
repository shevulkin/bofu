...
class Attrs
{
    ...
    /**
     * Характеристики, доречні для категорії: прив'язані до неї + загальні (без прив'язки).
     ...
     * $categoryId — нова характеристика одразу прив'язується до категорії товару,
    ...
    /**
     * Прив'язати кожну характеристику до категорій, де вона реально вживається.
     * Якщо вживається в усіх категоріях — лишаємо загальною (без прив'язки).
     */
