...
class Seeder
{
    public static function run(): void
    {
        ...
        // --- товари (з дизайну) ---
        $products = [
            ['honey', 'Мед різнотрав\'я, 350г', 'Класичний мед з різнотрав\'я власної пасіки.', 180, 34, 'img/honey-jar.png', 1, [['Вага','350 г'],['Походження','Власна пасіка, Україна'],['Термін зберігання','24 місяці'],['Умови зберігання','Сухе, темне місце, до +20°C']], []],
            ['honey', 'Мед соняшниковий, 350г', 'Ніжний, швидко кристалізується.', 160, 28, 'img/honey-jar.png', 0, [['Вага','350 г'],['Походження','Власна пасіка, Україна'],['Термін зберігання','24 місяці'],['Особливість','Швидка природна кристалізація']], []],
            ['honey', 'Набір "Пасічник", 3х350г', 'Три види меду в подарунковій коробці.', 480, 12, 'img/honey-jar.png', 0, [['Вміст','3 банки по 350 г'],['Походження','Власна пасіка, Україна'],['Упаковка','Подарункова коробка'],['Термін зберігання','24 місяці']], []],
        ...
        $blocks = [
            ...
            ['gallery', null, json_encode([
                ['Бджільництво', 'img/gallery-1.png'], ['Чикаго', 'img/gallery-2.png'],
                ['Вдалий медозбір', 'img/gallery-3.png'], ['Подорож Америкою', 'img/gallery-4.png'],
                ['Спікер у школі аграрія', 'img/gallery-5.png'],
            ], JSON_UNESCAPED_UNICODE)],
