...
class Seeder
{
    public static function run(): void
    {
        ...
        // --- категорії (з дизайну) ---
        $cats = [
            ['honey', 'Мед і смаколики', 'product'], ['health', 'Для здоровʼя', 'product'],
        ...
        // --- товари (з дизайну) ---
        $products = [
            ['honey', 'Мед різнотравʼя, 350г', 'Класичний мед з різнотравʼя власної пасіки.', 180, 34, ['img/honey-jar.webp', 'img/gallery-1.webp', 'img/gallery-2.webp'], 1, [['Вага','350 г'],['Походження','Власна пасіка, Україна'],['Термін зберігання','24 місяці'],['Умови зберігання','Сухе, темне місце, до +20°C']], []],
            ...
            ['honey', 'Набір «Пасічник», 3×350 г', 'Три види меду в подарунковій коробці.', 480, 12, 'img/honey-jar.webp', 0, [['Вміст','3 банки по 350 г'],['Походження','Власна пасіка, Україна'],['Упаковка','Подарункова коробка'],['Термін зберігання','24 місяці']], []],
