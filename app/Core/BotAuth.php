...
class BotAuth
{
    ...
    public const TEXTS = [
        ...
        /*
         * Viber не вміє довести, що надісланий номер належить саме
         * співрозмовнику: у контакті немає поля, з яким це можна звірити (у
         * Telegram воно є). Тому в наявний акаунт таким контактом ми не
         * впускаємо — і людині треба сказати не «помилка», а що робити далі.
         *
         * Три названі шляхи не випадкові: код на номер приходить у вже
         * підключений месенджер, тобто туди, куди сторонній не дістане.
         */
        'bot_viber_known_phone' => [
            "На цей номер уже є акаунт на сайті {site_name}.\n\n"
            . "Увійти в нього через Viber не можна: Viber не підтверджує, що номер саме ваш.\n\n"
            . 'Скористайтесь входом через Google чи Telegram або кодом на номер — код прийде у месенджер, '
            . 'уже підключений до акаунта.',
            'Номер уже має акаунт — вхід через Viber не надається (доступний {site_name})',
        ],
        'bot_expired' => [
