  ...
  <div class="container narrow">
    ...
    <div class="card" style="margin-top:36px">
      <div class="card-body" style="padding:32px">
        <div class="card-title" style="font-size:28px"><?= e(Content::title('course_1')) ?></div>
        <div class="card-desc" style="font-size:15.5px;margin-top:8px"><?= e(Content::get('course_1')) ?></div>
        <div class="card-foot" style="margin-top:22px">
          <span class="price" style="font-size:20px">За запитом</span>
          <a class="btn btn-gold" href="<?= e(Content::title('course_1_link', '#')) ?>" target="_blank" rel="noopener">Записатись</a>
        </div>
      </div>
    </div>
