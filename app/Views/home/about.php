<section class="section" style="padding-top:48px">
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:1fr 1.3fr;gap:56px;align-items:start" data-rg="1">
      <img src="<?= e(asset(Content::image('about_full', 'img/about-photo.webp'))) ?>" alt="Про мене" style="border-radius:4px;border:1px solid var(--line2);width:100%;object-fit:cover"<?= edit_mark('about_full', 'image') ?>>
      <div>
        <div class="kicker">Хто я</div>
        <h1 style="font-size:44px"<?= edit_mark('about_full', 'title') ?>><?= e(Content::title('about_full', 'Бджоляр, блогер, підприємець')) ?></h1>
        <p class="lead" style="margin-top:22px;white-space:pre-line"<?= edit_mark('about_full', 'body') ?>><?= e(Content::get('about_full')) ?></p>
      </div>
    </div>
