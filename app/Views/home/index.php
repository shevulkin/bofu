...
<section class="hero">
  <div>
    <div class="hero-badge"><?= e(Content::title('hero_badge', 'Аспірант · Бджоляр · Блогер · Підприємець')) ?></div>
    <h1><?= e(Content::title('hero_title', 'Назарій Білько — Beekeeper of Ukraine')) ?></h1>
    <p class="lead"><?= e(Content::get('hero_text')) ?></p>
...
<div class="container">
  <div class="counters">
    <div class="counter"><b data-count-to="<?= e(Content::title('counter_graduates', '153')) ?>">0</b><span>випускників курсів</span></div>
    <div class="counter"><b><?= e(Content::title('counter_courses', '1')) ?></b><span>авторських курсів</span></div>
    <div class="counter"><b><?= e(Content::title('counter_founded', '2022')) ?></b><span>рік заснування</span></div>
  </div>
</div>
...
<section class="section" style="background:var(--bg2)">
  <div class="container" style="display:grid;grid-template-columns:1fr 1.2fr;gap:56px;align-items:center" data-rg="1">
    ...
    <div>
      ...
      <p class="lead" style="margin:20px 0 26px"><?= e(Content::get('about_teaser')) ?></p>
  ...
  <div class="container">
    ...
    <div class="card center-block" style="max-width:640px">
      <div class="card-body" style="padding:30px">
        <div class="card-title" style="font-size:26px"><?= e(Content::title('course_1')) ?></div>
        <div class="card-desc" style="font-size:15px"><?= e(Content::get('course_1')) ?></div>
        <div class="card-foot">
          <span class="price">За запитом</span>
          <a class="btn btn-gold btn-sm" href="<?= e(Content::title('course_1_link', '#')) ?>" target="_blank" rel="noopener">Записатись</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div style="margin-top:18px">
      <?php foreach (['why_1', 'why_2', 'why_3'] as $i => $key): ?>
        <div class="why-item">
          ...
          <div>
            <div style="font-family:var(--serif);font-size:22px;font-weight:600"><?= e(Content::title($key)) ?></div>
            <p class="muted" style="margin-top:6px"><?= e(Content::get($key)) ?></p>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
...
<section class="section">
  <div class="container">
    ...
    <div style="display:flex;gap:18px;flex-wrap:wrap">
      <?php
      $mini = [
        ['Instagram', Content::title('social_instagram', '#'), '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#E4405F" stroke-width="2"><rect x="2.5" y="2.5" width="19" height="19" rx="5.2"/><circle cx="12" cy="12" r="4.6"/><circle cx="17.6" cy="6.4" r="1.3" fill="#E4405F" stroke="none"/></svg>'],
        ['YouTube', Content::title('social_youtube', '#'), '<svg viewBox="0 0 24 24" width="20" height="20"><path fill="#FF0000" d="M23.5 6.5a3 3 0 0 0-2.1-2.2C19.5 3.8 12 3.8 12 3.8s-7.5 0-9.4.5A3 3 0 0 0 .5 6.5 31 31 0 0 0 0 12a31 31 0 0 0 .5 5.5 3 3 0 0 0 2.1 2.2c1.9.5 9.4.5 9.4.5s7.5 0 9.4-.5a3 3 0 0 0 2.1-2.2A31 31 0 0 0 24 12a31 31 0 0 0-.5-5.5z"/><path fill="#fff" d="M9.6 15.6V8.4L15.8 12l-6.2 3.6z"/></svg>'],
        ['TikTok', Content::title('social_tiktok', '#'), '<svg viewBox="0 0 24 24" width="20" height="20"><path fill="#f6ecd9" d="M16.6 2h3.1c.2 1.9 1.4 3.6 3.3 4v3.1c-1.2 0-2.4-.4-3.4-1v6.9a6.9 6.9 0 1 1-6.9-6.9c.3 0 .7 0 1 .1v3.3a3.6 3.6 0 1 0 2.9 3.5V2z"/></svg>'],
      ];
      foreach ($mini as [$name, $link, $icon]): ?>
        <a class="chip" href="<?= e($link) ?>" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:9px;text-transform:none;letter-spacing:0;font-size:13.5px"><?= $icon ?><?= e($name) ?></a>
      <?php endforeach; ?>
    </div>
  </div>
</section>
...
<section class="section" style="background:var(--bg2);text-align:center">
  <div class="container narrow">
    <h2><?= e(Content::title('final_cta_title', 'Готові розпочати?')) ?></h2>
    <p class="lead" style="margin:16px auto 30px"><?= e(Content::get('final_cta_text')) ?></p>
