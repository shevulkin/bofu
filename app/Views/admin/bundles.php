...
«Будь-який варіант» означає, що покупцю все одно, яку фасовку брати: набір збереться з тієї, що вже лежить у кошику. Обирайте конкретну лише тоді, коли інша справді не годиться.
