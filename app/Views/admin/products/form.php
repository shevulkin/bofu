...
Галка стоїть — замість «немає в наявності» він побачить «Виготовимо під замовлення», а в кошику «Немає в магазинах — виготовимо під замовлення».

Галка знята — побачить, що товару немає.

Важливо розуміти межу: це напис, а не заборона. Замовити понад залишок сайт дозволяє в обох випадках — і з галкою, і без неї. Тому знята галка не захистить від замовлення того, чого немає; вона лише не обіцяє покупцю виготовлення.">
