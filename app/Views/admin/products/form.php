...
Для меду й решти звичайних товарів залишайте порожнім: зайвий код у чеку нікому не допомагає, а помилковий створює розбіжність у звітності.">
  ...
  <div class="admin-card">
    ...
    <p class="dim" style="margin:-8px 0 18px">
      ...
      й спрацьовує в кошику сама — рахувати руками й правити суму замовлення не потрібно.
    </p>
...
«Усі варіанти разом» — свічки різного кольору, банки різного обʼєму, набори одного й того самого. Три плюс дві дають пʼять, і поріг «від 5 шт» спрацьовує. Так стоїть у більшості товарів.
...
З даних ця різниця не виводиться — її знаєте лише ви. Помилка тут не ламає нічого, але дає покупцю не ту ціну, на яку ви розраховували.">
    ...
    <div style="margin-top:18px;max-width:520px" data-help-title="Шкала товару"
         data-help="Пороги саме цього товару: від скількох штук і скільки відсотків.

Заповнена шкала повністю замінює шкалу розділу — не додається до неї й не змішується з нею. Саме тому тут можна зробити опт меншим за розділ, а не лише більшим.

Порожня шкала означає «як у розділі». Щоб опту не було зовсім, зніміть галку «Опт діє на цей товар» угорі.

Пороги мають зростати: «від 10 шт» зобовʼязане давати більше за «від 5 шт», інакше покупцю немає сенсу брати десять.">
      <h3 style="margin:0 0 10px;font-size:15px">Шкала цього товару</h3>
...
Три-пʼять пунктів. Довший список читають по діагоналі.">
      ...
      <textarea name="learn_outcomes" rows="5" placeholder="Самостійно виводити маток&#10;Планувати кочівлю на медозбір&#10;Рахувати економіку пасіки на 100 вуликів"><?= e((string)($p['learn_outcomes'] ?? '')) ?></textarea>
    </div>
...
Відповідає на питання «наскільки це серйозно». Тому конкретика: не «теорія», а «Біологія бджолиної сімʼї: цикл, ролі, зимівля».">
      ...
      <textarea name="program" rows="7" placeholder="Біологія бджолиної сімʼї&#10;Обладнання промислової пасіки&#10;Виведення маток"><?= e((string)($p['program'] ?? '')) ?></textarea>
    </div>
