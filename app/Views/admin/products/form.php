...
Поле необовʼязкове. Якщо ведете склад у таблиці чи 1С, ставте тут той самий код, що й там.">
      ...
      <div class="field" data-help-title="Бренд (чий товар)"
           data-help="Хто виробник цієї позиції: «SINCERA», «Апіпродукт», «<?= e(Catalog::ownBrand()) ?>».

Своє виробництво підписуйте саме «<?= e(Catalog::ownBrand()) ?>» — тоді на сторінці товару, якого немає на складі, покупець побачить «Виготовимо під замовлення — ми виробник». Для решти напис буде нейтральний: «Виготовляється на замовлення — привеземо для вас».

Це твердження про походження товару, тому вгадувати його сайт не буде: порожнє поле означає «не наше».

Бренд також показується покупцю в характеристиках і йде в розмітку для Google.">
        <label>Бренд</label><input type="text" name="brand" value="<?= e($p['brand'] ?? '') ?>"
               placeholder="<?= e(Catalog::ownBrand()) ?>" <?= $roEdit ?>></div>
