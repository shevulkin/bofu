...
Порядок задають руками, бо він означає щось для вас, а не для комп'ютера: за абеткою найголовніший партнер опинився б посередині списку.">
...
Порожньо — картка лишається, але не клікається. Це нормально для партнера без сайту: господарство часто має лише сторінку в Instagram, її теж можна вставити сюди.">
          <label>Сайт (необов'язково)</label>
