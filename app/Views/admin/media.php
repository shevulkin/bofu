<div class="admin-head">
  ...
  <form method="post" action="<?= e(url('/admin/media')) ?>" enctype="multipart/form-data" style="display:flex;gap:10px;align-items:center">
    ...
    <input type="file" name="image" accept="image/*" required data-help-title="Вибір файлу"
           data-help="Оберіть зображення на своєму компʼютері.
...
<p class="dim" style="margin-bottom:18px">Усі фото сайту. Хрестик видаляє фото звідусіль. Фото, привʼязані до товарів, банерів чи галереї, видалити не можна — спершу приберіть/замініть їх там (посилання під фото). Вбудовані фото дизайну видалити не можна.</p>
